...
V drugem načinu smo samo v prvi iteraciji naključno generirali graf. Nato smo v vsaki iteraciji namesto nove neodvisne generacije grafa vzeli že obstoječ graf, izbrali dve naključni povezavi v grafu in ju zamenjali v naključno izbrani smeri. Ponovno smo preverili in popravili graf, če smo z zamenjavo povezav povečali premer. Za vsak $n$ od 10 do 30 vključno, smo s tem pristopom izvedli 1000 poskusov. Na sliki 1 in 2 lahko vidimo prvi in zadnji graf iteracije pri tem postopku pri $n = 10$ in $n = 11$.
